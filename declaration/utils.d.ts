...
import { MoveableManagerState, Able, MoveableClientRect, MoveableProps, ArrayFormat, MoveableRefType, MatrixInfo, ExcludeEndParams, ExcludeParams, ElementSizes, MoveablePosition, TransformObject } from "./types";
...
export declare function fillCSSObject(style: Record<string, any>, resolvedEvent?: any): {
...
export declare function getElementTargets(targets: Array<SVGElement | HTMLElement | string | null | undefined>, selectorMap: IObject<Array<HTMLElement | SVGElement>>): (HTMLElement | SVGElement)[];
